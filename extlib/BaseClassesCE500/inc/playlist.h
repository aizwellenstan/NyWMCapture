...
/* interface __MIDL_itf_playlist_0242 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_playlist_0242_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_playlist_0242_v0_0_s_ifspec;
...
EXTERN_C const IID IID_IBufferingTime;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE GetBufferingTime( 
            DWORD __RPC_FAR *pdwMilliseconds) = 0;
    ...
    typedef struct IBufferingTimeVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetBufferingTime )( 
            IBufferingTime __RPC_FAR * This,
            DWORD __RPC_FAR *pdwMilliseconds);
    ...
    interface IBufferingTime
    {
        CONST_VTBL struct IBufferingTimeVtbl __RPC_FAR *lpVtbl;
    };
...
HRESULT STDMETHODCALLTYPE IBufferingTime_GetBufferingTime_Proxy( 
    IBufferingTime __RPC_FAR * This,
    DWORD __RPC_FAR *pdwMilliseconds);


void __RPC_STUB IBufferingTime_GetBufferingTime_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBufferingTime_SetBufferingTime_Proxy( 
    IBufferingTime __RPC_FAR * This,
    DWORD dwMilliseconds);


void __RPC_STUB IBufferingTime_SetBufferingTime_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* interface __MIDL_itf_playlist_0245 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_playlist_0245_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_playlist_0245_v0_0_s_ifspec;
