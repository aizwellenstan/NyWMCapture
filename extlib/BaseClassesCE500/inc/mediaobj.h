...
enum _DMO_PROCESS_OUTPUT_FLAGS
	...
	DMO_PROCESS_OUTPUT_DO_ROTATE90	= 0x10000000,
...
EXTERN_C const IID IID_IMediaBuffer;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE GetMaxLength( 
            /* [out] */ DWORD __RPC_FAR *pcbMaxLength) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE GetBufferAndLength( 
            /* [out] */ BYTE __RPC_FAR *__RPC_FAR *ppBuffer,
            /* [out] */ DWORD __RPC_FAR *pcbLength) = 0;
    ...
    typedef struct IMediaBufferVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetMaxLength )( 
            IMediaBuffer __RPC_FAR * This,
            /* [out] */ DWORD __RPC_FAR *pcbMaxLength);
    ...
    interface IMediaBuffer
    {
        CONST_VTBL struct IMediaBufferVtbl __RPC_FAR *lpVtbl;
    };
...
/* interface __MIDL_itf_mediaobj_0057 */
/* [local] */ 

typedef struct _DMO_OUTPUT_DATA_BUFFER
    {
    IMediaBuffer __RPC_FAR *pBuffer;
    DWORD dwStatus;
    REFERENCE_TIME rtTimestamp;
    REFERENCE_TIME rtTimelength;
    }	DMO_OUTPUT_DATA_BUFFER;

typedef struct _DMO_OUTPUT_DATA_BUFFER __RPC_FAR *PDMO_OUTPUT_DATA_BUFFER;



extern RPC_IF_HANDLE __MIDL_itf_mediaobj_0057_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_mediaobj_0057_v0_0_s_ifspec;
...
EXTERN_C const IID IID_IMediaObject;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE GetStreamCount( 
            /* [out] */ DWORD __RPC_FAR *pcInputStreams,
            /* [out] */ DWORD __RPC_FAR *pcOutputStreams) = 0;
        ...
        virtual HRESULT STDMETHODCALLTYPE GetInputType( 
            DWORD dwInputStreamIndex,
            DWORD dwTypeIndex,
            /* [out] */ DMO_MEDIA_TYPE __RPC_FAR *pmt) = 0;
        ...
        virtual HRESULT STDMETHODCALLTYPE SetInputType( 
            DWORD dwInputStreamIndex,
            /* [in] */ const DMO_MEDIA_TYPE __RPC_FAR *pmt,
            DWORD dwFlags) = 0;
        ...
        virtual HRESULT STDMETHODCALLTYPE GetInputSizeInfo( 
            DWORD dwInputStreamIndex,
            /* [out] */ DWORD __RPC_FAR *pcbSize,
            /* [out] */ DWORD __RPC_FAR *pcbMaxLookahead,
            /* [out] */ DWORD __RPC_FAR *pcbAlignment) = 0;
        ...
        virtual HRESULT STDMETHODCALLTYPE GetInputMaxLatency( 
            DWORD dwInputStreamIndex,
            /* [out] */ REFERENCE_TIME __RPC_FAR *prtMaxLatency) = 0;
        ...
        virtual HRESULT STDMETHODCALLTYPE ProcessOutput( 
            ...
            /* [size_is][out][in] */ DMO_OUTPUT_DATA_BUFFER __RPC_FAR *pOutputBuffers,
    ...
    typedef struct IMediaObjectVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetStreamCount )( 
            IMediaObject __RPC_FAR * This,
            /* [out] */ DWORD __RPC_FAR *pcInputStreams,
            /* [out] */ DWORD __RPC_FAR *pcOutputStreams);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetInputStreamInfo )( 
            IMediaObject __RPC_FAR * This,
            DWORD dwInputStreamIndex,
            /* [out] */ DWORD __RPC_FAR *pdwFlags);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetOutputStreamInfo )( 
            IMediaObject __RPC_FAR * This,
            DWORD dwOutputStreamIndex,
            /* [out] */ DWORD __RPC_FAR *pdwFlags);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetInputType )( 
            IMediaObject __RPC_FAR * This,
            DWORD dwInputStreamIndex,
            DWORD dwTypeIndex,
            /* [out] */ DMO_MEDIA_TYPE __RPC_FAR *pmt);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetOutputType )( 
            IMediaObject __RPC_FAR * This,
            DWORD dwOutputStreamIndex,
            DWORD dwTypeIndex,
            /* [out] */ DMO_MEDIA_TYPE __RPC_FAR *pmt);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *SetInputType )( 
            IMediaObject __RPC_FAR * This,
            DWORD dwInputStreamIndex,
            /* [in] */ const DMO_MEDIA_TYPE __RPC_FAR *pmt,
            DWORD dwFlags);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *SetOutputType )( 
            IMediaObject __RPC_FAR * This,
            DWORD dwOutputStreamIndex,
            /* [in] */ const DMO_MEDIA_TYPE __RPC_FAR *pmt,
            DWORD dwFlags);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetInputCurrentType )( 
            IMediaObject __RPC_FAR * This,
            DWORD dwInputStreamIndex,
            /* [out] */ DMO_MEDIA_TYPE __RPC_FAR *pmt);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetOutputCurrentType )( 
            IMediaObject __RPC_FAR * This,
            DWORD dwOutputStreamIndex,
            /* [out] */ DMO_MEDIA_TYPE __RPC_FAR *pmt);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetInputSizeInfo )( 
            IMediaObject __RPC_FAR * This,
            DWORD dwInputStreamIndex,
            /* [out] */ DWORD __RPC_FAR *pcbSize,
            /* [out] */ DWORD __RPC_FAR *pcbMaxLookahead,
            /* [out] */ DWORD __RPC_FAR *pcbAlignment);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetOutputSizeInfo )( 
            IMediaObject __RPC_FAR * This,
            DWORD dwOutputStreamIndex,
            /* [out] */ DWORD __RPC_FAR *pcbSize,
            /* [out] */ DWORD __RPC_FAR *pcbAlignment);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetInputMaxLatency )( 
            IMediaObject __RPC_FAR * This,
            DWORD dwInputStreamIndex,
            /* [out] */ REFERENCE_TIME __RPC_FAR *prtMaxLatency);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *SetInputMaxLatency )( 
            IMediaObject __RPC_FAR * This,
            DWORD dwInputStreamIndex,
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *Discontinuity )( 
            IMediaObject __RPC_FAR * This,
            DWORD dwInputStreamIndex);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *AllocateStreamingResources )( 
            IMediaObject __RPC_FAR * This);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *FreeStreamingResources )( 
            IMediaObject __RPC_FAR * This);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetInputStatus )( 
            IMediaObject __RPC_FAR * This,
            DWORD dwInputStreamIndex,
            /* [out] */ DWORD __RPC_FAR *dwFlags);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *ProcessInput )( 
            IMediaObject __RPC_FAR * This,
            DWORD dwInputStreamIndex,
            IMediaBuffer __RPC_FAR *pBuffer,
            DWORD dwFlags,
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *ProcessOutput )( 
            IMediaObject __RPC_FAR * This,
            DWORD dwFlags,
            DWORD cOutputBufferCount,
            /* [size_is][out][in] */ DMO_OUTPUT_DATA_BUFFER __RPC_FAR *pOutputBuffers,
    ...
    interface IMediaObject
    {
        CONST_VTBL struct IMediaObjectVtbl __RPC_FAR *lpVtbl;
    };
...
EXTERN_C const IID IID_IEnumDMO;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE Next( 
            DWORD cItemsToFetch,
            /* [length_is][size_is][out] */ CLSID __RPC_FAR *pCLSID,
            /* [string][length_is][size_is][out] */ WCHAR __RPC_FAR *__RPC_FAR *Names,
            /* [out] */ DWORD __RPC_FAR *pcItemsFetched) = 0;
        ...
        virtual HRESULT STDMETHODCALLTYPE Clone( 
            /* [out] */ IEnumDMO __RPC_FAR *__RPC_FAR *ppEnum) = 0;
    ...
    typedef struct IEnumDMOVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *Next )( 
            ...
            /* [length_is][size_is][out] */ CLSID __RPC_FAR *pCLSID,
            /* [string][length_is][size_is][out] */ WCHAR __RPC_FAR *__RPC_FAR *Names,
            /* [out] */ DWORD __RPC_FAR *pcItemsFetched);
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *Clone )( 
            IEnumDMO __RPC_FAR * This,
            /* [out] */ IEnumDMO __RPC_FAR *__RPC_FAR *ppEnum);
    ...
    interface IEnumDMO
    {
        CONST_VTBL struct IEnumDMOVtbl __RPC_FAR *lpVtbl;
    };
...
/* interface __MIDL_itf_mediaobj_0059 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_mediaobj_0059_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_mediaobj_0059_v0_0_s_ifspec;
...
EXTERN_C const IID IID_IMediaObjectInPlace;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE Clone( 
            /* [out] */ IMediaObjectInPlace __RPC_FAR *__RPC_FAR *ppMediaObject) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE GetLatency( 
            /* [out] */ REFERENCE_TIME __RPC_FAR *pLatencyTime) = 0;
    ...
    typedef struct IMediaObjectInPlaceVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryInterface )( 
            IMediaObjectInPlace __RPC_FAR * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void __RPC_FAR *__RPC_FAR *ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *Clone )( 
            IMediaObjectInPlace __RPC_FAR * This,
            /* [out] */ IMediaObjectInPlace __RPC_FAR *__RPC_FAR *ppMediaObject);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetLatency )( 
            IMediaObjectInPlace __RPC_FAR * This,
            /* [out] */ REFERENCE_TIME __RPC_FAR *pLatencyTime);
    ...
    interface IMediaObjectInPlace
    {
        CONST_VTBL struct IMediaObjectInPlaceVtbl __RPC_FAR *lpVtbl;
    };
...
/* interface __MIDL_itf_mediaobj_0060 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_mediaobj_0060_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_mediaobj_0060_v0_0_s_ifspec;
...
EXTERN_C const IID IID_IDMOQualityControl;
    ...
    typedef struct IDMOQualityControlVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryInterface )( 
            IDMOQualityControl __RPC_FAR * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void __RPC_FAR *__RPC_FAR *ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *SetNow )( 
            IDMOQualityControl __RPC_FAR * This,
    ...
    interface IDMOQualityControl
    {
        CONST_VTBL struct IDMOQualityControlVtbl __RPC_FAR *lpVtbl;
    };
...
/* interface __MIDL_itf_mediaobj_0061 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_mediaobj_0061_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_mediaobj_0061_v0_0_s_ifspec;
...
EXTERN_C const IID IID_IDMOVideoOutputOptimizations;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE QueryOperationModePreferences( 
            ...
            DWORD __RPC_FAR *pdwRequestedCapabilities) = 0;
        ...
        virtual HRESULT STDMETHODCALLTYPE GetCurrentOperationMode( 
            ULONG ulOutputStreamIndex,
            DWORD __RPC_FAR *pdwEnabledFeatures) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE GetCurrentSampleRequirements( 
            ULONG ulOutputStreamIndex,
            DWORD __RPC_FAR *pdwRequestedFeatures) = 0;
    ...
    typedef struct IDMOVideoOutputOptimizationsVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryInterface )( 
            IDMOVideoOutputOptimizations __RPC_FAR * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void __RPC_FAR *__RPC_FAR *ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryOperationModePreferences )( 
            IDMOVideoOutputOptimizations __RPC_FAR * This,
            ULONG ulOutputStreamIndex,
            DWORD __RPC_FAR *pdwRequestedCapabilities);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *SetOperationMode )( 
            IDMOVideoOutputOptimizations __RPC_FAR * This,
            ULONG ulOutputStreamIndex,
            DWORD dwEnabledFeatures);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetCurrentOperationMode )( 
            IDMOVideoOutputOptimizations __RPC_FAR * This,
            ULONG ulOutputStreamIndex,
            DWORD __RPC_FAR *pdwEnabledFeatures);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetCurrentSampleRequirements )( 
            IDMOVideoOutputOptimizations __RPC_FAR * This,
            ULONG ulOutputStreamIndex,
            DWORD __RPC_FAR *pdwRequestedFeatures);
    ...
    interface IDMOVideoOutputOptimizations
    {
        CONST_VTBL struct IDMOVideoOutputOptimizationsVtbl __RPC_FAR *lpVtbl;
    };
